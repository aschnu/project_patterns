...
public class Exercise {
    ...
    private AbstractNotification buildFastNotificationFromInput(Map<String, String> notificationData) {
        ...
        if (notificationData.get(NotificationDetails.FIELD.COMMON.WALLET.getFieldName()).equalsIgnoreCase(Wallet.ANDROID.getWalletName())) {
            ...
            return AndroidNotification.AndroidNotificationBuilder.anAndroidNotification()
                    .withCommonValues(inputMapper.mapToTransactionSumOrNumber(notificationData.get(NotificationDetails.FIELD.COMMON.TRANSACTION_SUM.getFieldName())),
                            inputMapper.mapToCardName(notificationData.get(NotificationDetails.FIELD.COMMON.CARD_NAME.getFieldName())))
                    .withDeviceType(inputMapper.mapToDeviceType(notificationData.get(NotificationDetails.FIELD.COMMON.DEVICE_TYPE.getFieldName())))
                    .withDeviceVersion(notificationData.get(NotificationDetails.FIELD.ANDROID.DEVICE_VERSION.getFieldName()))
                    .build();
            ...
            return AppleNotification.AppleNotificationBuilder.anAppleNotification()
                    .withCommonValues(inputMapper.mapToTransactionSumOrNumber(notificationData.get(NotificationDetails.FIELD.COMMON.TRANSACTION_SUM.getFieldName())),
                            inputMapper.mapToCardName(notificationData.get(NotificationDetails.FIELD.COMMON.CARD_NAME.getFieldName())))
                    .withSecurity(inputMapper.mapToSecurity(notificationData.get(NotificationDetails.FIELD.APPLE.SECURITY.getFieldName())))
                    .build();
            ...
            return SamsungNotification.SamsungNotificationBuilder.aSamsungNotification()
                    .withCommonValues(inputMapper.mapToTransactionSumOrNumber(notificationData.get(NotificationDetails.FIELD.COMMON.TRANSACTION_SUM.getFieldName())),
                            inputMapper.mapToCardName(notificationData.get(NotificationDetails.FIELD.COMMON.CARD_NAME.getFieldName())))
                    .withDeviceType(inputMapper.mapToDeviceType(notificationData.get(NotificationDetails.FIELD.COMMON.DEVICE_TYPE.getFieldName())))
                    .build();
    ...
    private AbstractNotification buildCustomNotificationFromInput(Map<String, String> notificationData) {
        ...
        if (notificationData.get(NotificationDetails.FIELD.COMMON.WALLET.getFieldName()).equalsIgnoreCase(Wallet.ANDROID.getWalletName())) {
            ...
            return AndroidNotification.AndroidNotificationBuilder.anAndroidNotification()
                    .withTransactionNumber(inputMapper.mapToTransactionSumOrNumber(notificationData.get(NotificationDetails.FIELD.COMMON.TRANSACTION_NUMBER.getFieldName())))
                    .withTransactionName(notificationData.get(NotificationDetails.FIELD.COMMON.TRANSACTION_NAME.getFieldName()))
                    .withIssuer(
                    ...
                    .withTransactionSum(inputMapper.mapToTransactionSumOrNumber(notificationData.get(NotificationDetails.FIELD.COMMON.TRANSACTION_SUM.getFieldName())))
                    .withTransactionDate(inputMapper.mapToTransactionDate(notificationData.get(NotificationDetails.FIELD.COMMON.TRANSACTION_DATE.getFieldName())))
                    .withDeviceType(inputMapper.mapToDeviceType(notificationData.get(NotificationDetails.FIELD.COMMON.DEVICE_TYPE.getFieldName())))
                    .withDeviceVersion(notificationData.get(NotificationDetails.FIELD.ANDROID.DEVICE_VERSION.getFieldName()))
                    .build();
